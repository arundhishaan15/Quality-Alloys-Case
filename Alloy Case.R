...
# These are shortlisted variables that have reasonable p values.  
# --> page_views:0.4, page_visit:0.08, avg_time_on_site:0.22,bounce_rate:0.122,percent_new_visit:0.3
# Finally we came up with these models comparing appropriate variables with success_inquiry
